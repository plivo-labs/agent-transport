...
from agent_transport.sip.pipecat import SipServerTransport, AudioRecorder
...
async def run_bot(transport, userdata):
    ...
    async def on_beep_timeout(transport):
        # No beep — human answered, start conversation
